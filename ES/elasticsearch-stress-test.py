...
parser.add_argument("--max-fields-per-document",type=int, default=100,  help="Max number of fields in each document (default 100)")
...
def generate_document():
    ...
    return temp_doc
    # return {"tkyfb": "ggids", "bigun": "lmqtl", "ikvku": "whlgv", "qqbno": "tpake", "xptxx": "pgcjw"}
...
def client_worker():
    ...
    while not has_timeout():
        ...
        for _ in range(BULK_SIZE):
            ...
            #print curr_bulk
            #{"index": {"_type": "stresstest", "_index": "my-index"}}
            #{"tkyfb": "ggids", "bigun": "lmqtl", "ikvku": "whlgv", "qqbno": "tpake", "xptxx": "pgcjw"}
...
def generate_indices():
    ...
    for _ in range(NUMBER_OF_INDICES):
        ...
        temp_index = generate_random_string(16)#generate a string length 0-16
